...
export const StatProfilScreen = (profil) => {
    ...
    return(
        <SafeAreaView style={{ flex: 1}}>
            <View style={{backgroundColor: primary,  flex:1, padding: 30}}>
                <TopScreenView>
                ...
                <View style={[{padding: 20, backgroundColor: secondary}, stylesCard.card]}>
